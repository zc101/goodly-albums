...
, checkPasswordByID: async function(userID, password) {
...
, checkPassword: async function(user, password) {
    if (typeof(user) === 'number')
      return pwutils.checkPasswordByID(user, password);
    else {
      ...
      if (id === null)
        ...
        return pwutils.checkPasswordByID(id, password);
    }
  ...
  // Returns a Boolean value
, updatePasswordByID: async function(userID, password) {
...
, updatePassword: async function(user, password) {
    if (typeof(user) === 'number')
      return pwutils.updatePasswordByID(user, password);
    else {
      ...
      if (id === null)
        ...
        return pwutils.updatePasswordByID(id, password);
    }
